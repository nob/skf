 ...
 * - enqueue_scripts()
 */
class Woo_Widget_AboutPage extends WP_Widget {
	...
	public function __construct() {
		...
		$this->woo_widget_description = __( 'About page widget.', 'woothemes' );
		$this->woo_widget_idbase = 'woo_about_page';
		$this->woo_widget_title = __( 'Woo - About page', 'woothemes' );
...
/* Register the widget. */
add_action( 'widgets_init', create_function( '', 'return register_widget("Woo_Widget_AboutPage");' ), 1 );
?>
