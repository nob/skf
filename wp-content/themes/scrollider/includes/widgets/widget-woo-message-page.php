 ...
 * - enqueue_scripts()
 */
class Woo_Widget_MessagePage extends WP_Widget {
	...
	public function __construct() {
		...
		$this->woo_widget_description = __( 'Message page widget.', 'woothemes' );
		$this->woo_widget_idbase = 'woo_message_page';
		$this->woo_widget_title = __( 'Woo - Message page', 'woothemes' );
...
/* Register the widget. */
add_action( 'widgets_init', create_function( '', 'return register_widget("Woo_Widget_MessagePage");' ), 1 );
?>
