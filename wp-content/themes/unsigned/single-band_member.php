<?php
/**
 * Single Band Member Template
 *
 * This template is the default template for "member" posts. It is used to display content when someone is viewing a
 * singular view of a post ('member' post_type).
 ...
 */
	get_header();
	global $woo_options, $woothemes_bandmembers;
